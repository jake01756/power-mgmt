...
### Created by Jake Thomas ( jake01756 ) on 2022-06-24
...
readonly script_author="jake@jakethomas.de"
readonly script_created="2022-06-24"
...
Option:usage() {
  ...
  IO:print "Purpose : ${txtInfo}This is my script power-mgmt${txtReset}"
